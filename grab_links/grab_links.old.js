...
Changes:
2013-02-23
- Fix the parsing of irregular links on the videolist
- Rewrite the youtube include-list
...
var bTestMode=false;
if (currSite == "localhost") { bTestMode=true; };
 ...
 *
 * @param Identifier - the key (id) of the element
 ...
 *
 * @param Mode - how the Identifier is interpreted (id, name, tagname)
 * @param Identifier - the key (id, name, tagname) of the element
 * @param ElementNumber - the index (only used for Mode=name, tagname)
 * @returns {Object} the found object or null
 */
 ...
 *
 * @param Identifier - the key (id) of the element
 * @param Text - the new text to set to the element
